    ...
    <table cellpadding="0" cellspacing="0" border="0" role="presentation" width="440" style="width:440px;border-collapse:collapse;table-layout:fixed;"><tr>
      ...
      <td width="302" style="width:302px;vertical-align:top;padding:0;">
        <table cellpadding="0" cellspacing="0" border="0" role="presentation" width="302" style="width:302px;border-collapse:collapse;table-layout:fixed;font-family:Arial,sans-serif;">
          ...
          <tr height="27"><td width="302" height="27" style="width:302px;height:27px;padding:0;vertical-align:middle;font-size:13px;line-height:18px;mso-line-height-rule:exactly;color:#333333;"><img src="${ASSETS.address}" width="18" height="18" alt="" style="display:inline-block;border:0;width:18px;height:18px;margin:0 8px 0 0;vertical-align:middle;">${d.address || "Address"}</td></tr>
          <tr height="27"><td width="302" height="27" style="width:302px;height:27px;padding:0;vertical-align:middle;font-size:13px;line-height:18px;mso-line-height-rule:exactly;"><img src="${ASSETS.phone}" width="18" height="18" alt="" style="display:inline-block;border:0;width:18px;height:18px;margin:0 8px 0 0;vertical-align:middle;"><a href="tel:${phoneHref}" style="color:#333333;text-decoration:none;">${d.phone || "Phone number"}</a></td></tr>
          <tr height="27"><td width="302" height="27" style="width:302px;height:27px;padding:0;vertical-align:middle;font-size:13px;line-height:18px;mso-line-height-rule:exactly;"><img src="${ASSETS.email}" width="18" height="18" alt="" style="display:inline-block;border:0;width:18px;height:18px;margin:0 8px 0 0;vertical-align:middle;"><a href="mailto:${d.email}" style="color:#333333;text-decoration:none;">${d.email || "Email address"}</a></td></tr>
          <tr height="27"><td width="302" height="27" style="width:302px;height:27px;padding:0;vertical-align:middle;font-size:13px;line-height:18px;mso-line-height-rule:exactly;"><img src="${ASSETS.website}" width="18" height="18" alt="" style="display:inline-block;border:0;width:18px;height:18px;margin:0 8px 0 0;vertical-align:middle;"><a href="https://www.prna.com.au" style="color:#333333;text-decoration:none;">www.prna.com.au</a></td></tr>
